...
class Maze:
    ...
    def get_neighbors(self, cell):
        ...
        return filter(lambda x: self.cell_is_valid(x) and self.check_wall(cell, x) == 0, around)
    ...
    def generate_maze(self, width, height):
        ...
        while len(visited_cells) < num_of_cells:
            ...
            unvisited_neighbors = list(filter(lambda x: x not in visited_cells and self.cell_is_valid(x), current_neighbors))
